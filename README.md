# ==============================================
# 步骤1：进入工程根目录（必做，避免路径错误）
# ==============================================
cd /vol2/1000/software/booklore

# ==============================================
# 步骤2：拉取 GitHub dev 分支最新代码（避免冲突）
# ==============================================
git pull origin dev

# ==============================================
# 步骤3：暂存所有修改/新增/删除（新手首选，不遗漏）
# ==============================================
git add .

# ==============================================
# 步骤4：提交修改（替换备注为实际修改内容）
# ==============================================
git commit -m "备注本次修改的内容"

# ==============================================
# 步骤5：推送到 GitHub dev 分支（完成同步）
# ==============================================
git push origin dev
