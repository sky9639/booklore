    ...
    conversation = [
        {
            ...
            "content": (
                f"<image_placeholder>\n"
                f"This is the front cover of a book titled '{book_title}'.\n\n"
                f"Look at this image carefully. I need you to describe ONLY the following "
                f"in comma-separated English tags (no sentences, no explanations):\n"
                f"1. The single most dominant art style (pick ONE: e.g. 'watercolor illustration' "
                f"or 'flat cartoon illustration' or 'oil painting' — not multiple)\n"
                f"2. The exact sky/background color (e.g. 'warm orange-pink sky', 'pale blue sky', "
                f"'golden sunset sky')\n"
                f"3. The exact ground/foreground color (e.g. 'bright green grass', 'dark stone ground')\n"
                f"4. The lighting mood in 2-3 words (e.g. 'soft warm backlight', 'bright daylight')\n"
                f"5. Background environment elements only — NO characters, NO title text "
                f"(e.g. 'rolling hills', 'scattered bones', 'distant castle silhouette')\n\n"
                f"Output ONLY the tags. Start with the art style tag."
            ),
            "images": [image],
        },
        {
